...
export const LightOrDark = (hex) => {
    ...
    // let gary = colorChange.reduce((curent,last,index)=>{
    //     let rate = index === 0 ? 0.299 : index === 1 ? 0.578 : 0.114
    //     return curent*rate + last
    // },0)
    let gary = colorChange[0]*0.299 + colorChange[1] * 0.578 + colorChange[2] * 0.114
    // let gary = colorChange.reduce((num, curent) => {
    //     return num + curent
    // }, 0) / 3
    // return gray >= 180
    console.log(hex);
